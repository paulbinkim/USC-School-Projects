...
struct Company {
    ...
    Company()  // Constructor of a base company
            : parent(nullptr), merge1(nullptr), merge2(nullptr) {}

    Company(Company* m1, Company* m2)  // Constructor of a merged company
            : parent(nullptr),
              merge1(m1)  // The parent pointer of m1 and m2 should update to this company
              ,
              merge2(m2) {}
};
...
private:
    ...
    /* Function to find the largest company
